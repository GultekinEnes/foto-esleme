      ...
      /*
        ...
        */
        ...
        function kutlama() {
            ...
            kutlamaGif.src = "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNW05N3UwMTFqdnIxMzV5ZHVkc215ZW9xbjBzc2xlNW5rM3F4eHlmYiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/blSTtZehjAZ8I/giphy.gif"
            document.body.appendChild(kutlamaGif);
            setTimeout(() => {
                document.body.removeChild(kutlamaGif);
            }, 5000);
            kutlamaGif.style.position = "absolute";
            kutlamaGif.style.left = "50%";
            kutlamaGif.style.top = "50%";
            kutlamaGif.style.transform = "translate(-50%, -50%)";
            kutlamaGif.style.width = "650px";
            kutlamaGif.style.height = "650px";
        }
